...
module Queue2_ReadDataChannel(	// src/main/scala/chisel3/util/Decoupled.scala:243:7
  ...
  always @(posedge clock) begin	// <stdin>:126:11
    if (reset) begin	// <stdin>:126:11
      wrap <= 1'h0;	// src/main/scala/chisel3/util/Counter.scala:61:40, src/main/scala/chisel3/util/Decoupled.scala:243:7
      wrap_1 <= 1'h0;	// src/main/scala/chisel3/util/Counter.scala:61:40, src/main/scala/chisel3/util/Decoupled.scala:243:7
      maybe_full <= 1'h0;	// src/main/scala/chisel3/util/Decoupled.scala:243:7, :259:27
    end
    else begin	// <stdin>:126:11
      automatic logic do_deq = io_deq_ready & ~empty;	// src/main/scala/chisel3/util/Decoupled.scala:51:35, :261:25, :285:19
      if (do_enq)	// src/main/scala/chisel3/util/Decoupled.scala:51:35
        wrap <= wrap - 1'h1;	// src/main/scala/chisel3/util/Counter.scala:61:40, :77:24
      if (do_deq)	// src/main/scala/chisel3/util/Decoupled.scala:51:35
...
module Counter(	// src/main/scala/chext/util/Counter.scala:6:7
  input  clock,	// <stdin>:177:11, :444:11
         reset,	// <stdin>:178:11, :445:11
  ...
  always @(posedge clock) begin	// <stdin>:177:11, :444:11
    if (reset)	// <stdin>:177:11, :444:11
...
module Queue4_ReadDataChannel(	// src/main/scala/chisel3/util/Decoupled.scala:243:7
  ...
  always @(posedge clock) begin	// <stdin>:201:11
    if (reset) begin	// <stdin>:201:11
      enq_ptr_value <= 2'h0;	// src/main/scala/chisel3/util/Counter.scala:61:40
      deq_ptr_value <= 2'h0;	// src/main/scala/chisel3/util/Counter.scala:61:40
      maybe_full <= 1'h0;	// src/main/scala/chisel3/util/Decoupled.scala:243:7, :259:27
    end
    else begin	// <stdin>:201:11
      automatic logic do_deq = io_deq_ready & ~empty;	// src/main/scala/chisel3/util/Decoupled.scala:51:35, :261:25, :285:19
      if (do_enq)	// src/main/scala/chisel3/util/Decoupled.scala:51:35
...
module SyncWriteElasticReadMemory(	// src/main/scala/chext/amba/axi4/full/components/IdParallelize.scala:41:15
  ...
  input  [7:0]  io_wrAddr,	// src/main/scala/chext/amba/axi4/full/components/IdParallelize.scala:53:14
  ...
  input  [7:0]  io_rdReq_bits,	// src/main/scala/chext/amba/axi4/full/components/IdParallelize.scala:53:14
  ...
  wire        _rdQueue_io_deq_valid;	// src/main/scala/chext/amba/axi4/full/components/IdParallelize.scala:73:25
  wire        _rdCounter_io_full;	// src/main/scala/chext/amba/axi4/full/components/IdParallelize.scala:69:27
  wire [66:0] _sram_mem_ext_R0_data;	// src/main/scala/chisel3/util/SRAM.scala:468:26
  wire        _GEN = ~_rdCounter_io_full & io_rdReq_valid;	// src/main/scala/chext/amba/axi4/full/components/IdParallelize.scala:69:27, src/main/scala/chext/util/Counter.scala:33:17, src/main/scala/chisel3/util/Decoupled.scala:51:35
  reg         r;	// src/main/scala/chext/amba/axi4/full/components/IdParallelize.scala:87:23
  always @(posedge clock)	// <stdin>:252:11
    r <= _GEN;	// src/main/scala/chext/amba/axi4/full/components/IdParallelize.scala:87:23, src/main/scala/chisel3/util/Decoupled.scala:51:35
  `ifdef ENABLE_INITIAL_REG_	// src/main/scala/chext/amba/axi4/full/components/IdParallelize.scala:41:15
    `ifdef FIRRTL_BEFORE_INITIAL	// src/main/scala/chext/amba/axi4/full/components/IdParallelize.scala:41:15
      `FIRRTL_BEFORE_INITIAL	// src/main/scala/chext/amba/axi4/full/components/IdParallelize.scala:41:15
    `endif // FIRRTL_BEFORE_INITIAL
    initial begin	// src/main/scala/chext/amba/axi4/full/components/IdParallelize.scala:41:15
      automatic logic [31:0] _RANDOM[0:0];	// src/main/scala/chext/amba/axi4/full/components/IdParallelize.scala:41:15
      `ifdef INIT_RANDOM_PROLOG_	// src/main/scala/chext/amba/axi4/full/components/IdParallelize.scala:41:15
        `INIT_RANDOM_PROLOG_	// src/main/scala/chext/amba/axi4/full/components/IdParallelize.scala:41:15
      `endif // INIT_RANDOM_PROLOG_
      `ifdef RANDOMIZE_REG_INIT	// src/main/scala/chext/amba/axi4/full/components/IdParallelize.scala:41:15
        _RANDOM[/*Zero width*/ 1'b0] = `RANDOM;	// src/main/scala/chext/amba/axi4/full/components/IdParallelize.scala:41:15
        r = _RANDOM[/*Zero width*/ 1'b0][0];	// src/main/scala/chext/amba/axi4/full/components/IdParallelize.scala:41:15, :87:23
      `endif // RANDOMIZE_REG_INIT
    end // initial
    `ifdef FIRRTL_AFTER_INITIAL	// src/main/scala/chext/amba/axi4/full/components/IdParallelize.scala:41:15
      `FIRRTL_AFTER_INITIAL	// src/main/scala/chext/amba/axi4/full/components/IdParallelize.scala:41:15
    `endif // FIRRTL_AFTER_INITIAL
  `endif // ENABLE_INITIAL_REG_
  ...
  Counter rdCounter (	// src/main/scala/chext/amba/axi4/full/components/IdParallelize.scala:69:27
    .clock    (clock),
    .reset    (reset),
    .io_incEn (_GEN),	// src/main/scala/chisel3/util/Decoupled.scala:51:35
    .io_decEn (io_rdResp_ready & _rdQueue_io_deq_valid),	// src/main/scala/chext/amba/axi4/full/components/IdParallelize.scala:73:25, src/main/scala/chisel3/util/Decoupled.scala:51:35
    .io_full  (_rdCounter_io_full)
  );
  Queue4_ReadDataChannel rdQueue (	// src/main/scala/chext/amba/axi4/full/components/IdParallelize.scala:73:25
    .clock            (clock),
    .reset            (reset),
    .io_enq_valid     (r),	// src/main/scala/chext/amba/axi4/full/components/IdParallelize.scala:87:23
  ...
  assign io_rdReq_ready = ~_rdCounter_io_full;	// src/main/scala/chext/amba/axi4/full/components/IdParallelize.scala:41:15, :69:27, src/main/scala/chext/util/Counter.scala:33:17
  assign io_rdResp_valid = _rdQueue_io_deq_valid;	// src/main/scala/chext/amba/axi4/full/components/IdParallelize.scala:41:15, :73:25
endmodule

module Counter_1(	// src/main/scala/chext/util/Counter.scala:6:7
  input  clock,	// <stdin>:318:11, :579:11
         reset,	// <stdin>:319:11, :580:11
         io_incEn,	// src/main/scala/chext/util/Counter.scala:7:14
         io_decEn,	// src/main/scala/chext/util/Counter.scala:7:14
  ...
  always @(posedge clock) begin	// <stdin>:318:11, :579:11
    if (reset)	// <stdin>:318:11, :579:11
...
module SyncWriteElasticReadMemory_1(	// src/main/scala/chext/amba/axi4/full/components/IdParallelize.scala:41:15
  input         clock,	// <stdin>:519:11
                reset,	// <stdin>:520:11
                io_wrEn,	// src/main/scala/chext/amba/axi4/full/components/IdParallelize.scala:53:14
  input  [5:0]  io_wrAddr,	// src/main/scala/chext/amba/axi4/full/components/IdParallelize.scala:53:14
  input  [1:0]  io_wrData_resp,	// src/main/scala/chext/amba/axi4/full/components/IdParallelize.scala:53:14
  input  [31:0] io_wrData_user,	// src/main/scala/chext/amba/axi4/full/components/IdParallelize.scala:53:14
  output        io_rdReq_ready,	// src/main/scala/chext/amba/axi4/full/components/IdParallelize.scala:53:14
  input         io_rdReq_valid,	// src/main/scala/chext/amba/axi4/full/components/IdParallelize.scala:53:14
  input  [5:0]  io_rdReq_bits,	// src/main/scala/chext/amba/axi4/full/components/IdParallelize.scala:53:14
  input         io_rdResp_ready,	// src/main/scala/chext/amba/axi4/full/components/IdParallelize.scala:53:14
  output        io_rdResp_valid,	// src/main/scala/chext/amba/axi4/full/components/IdParallelize.scala:53:14
  output [1:0]  io_rdResp_bits_resp,	// src/main/scala/chext/amba/axi4/full/components/IdParallelize.scala:53:14
  ...
  wire        _GEN = ~_rdCounter_io_full & io_rdReq_valid;	// src/main/scala/chext/amba/axi4/full/components/IdParallelize.scala:69:27, src/main/scala/chext/util/Counter.scala:33:17, src/main/scala/chisel3/util/Decoupled.scala:51:35
  reg         r;	// src/main/scala/chext/amba/axi4/full/components/IdParallelize.scala:87:23
  always @(posedge clock)	// <stdin>:519:11
    r <= _GEN;	// src/main/scala/chext/amba/axi4/full/components/IdParallelize.scala:87:23, src/main/scala/chisel3/util/Decoupled.scala:51:35
  `ifdef ENABLE_INITIAL_REG_	// src/main/scala/chext/amba/axi4/full/components/IdParallelize.scala:41:15
    `ifdef FIRRTL_BEFORE_INITIAL	// src/main/scala/chext/amba/axi4/full/components/IdParallelize.scala:41:15
      `FIRRTL_BEFORE_INITIAL	// src/main/scala/chext/amba/axi4/full/components/IdParallelize.scala:41:15
  ...
  Queue4_WriteResponseChannel rdQueue (	// src/main/scala/chext/amba/axi4/full/components/IdParallelize.scala:73:25
    .clock            (clock),
    .reset            (reset),
    .io_enq_valid     (r),	// src/main/scala/chext/amba/axi4/full/components/IdParallelize.scala:87:23
...
// VCS coverage exclude_file
module read_xIndexFill_64x8(	// src/main/scala/chext/amba/axi4/full/components/IdParallelize.scala:123:25
  input  [5:0] R0_addr,
  input        R0_en,
               R0_clk,
  output [7:0] R0_data,
  ...
  reg [7:0] Memory[0:63];	// src/main/scala/chext/amba/axi4/full/components/IdParallelize.scala:123:25
    ...
    initial begin	// src/main/scala/chext/amba/axi4/full/components/IdParallelize.scala:123:25
      ...
      `ifdef RANDOMIZE_MEM_INIT	// src/main/scala/chext/amba/axi4/full/components/IdParallelize.scala:123:25
        for (logic [6:0] i = 7'h0; i < 7'h40; i += 7'h1) begin
          ...
          Memory[i[5:0]] = _RANDOM_MEM[7:0];	// src/main/scala/chext/amba/axi4/full/components/IdParallelize.scala:123:25
        end	// src/main/scala/chext/amba/axi4/full/components/IdParallelize.scala:123:25
      `endif // RANDOMIZE_MEM_INIT
    end // initial
  `endif // ENABLE_INITIAL_MEM_
  assign R0_data = R0_en ? Memory[R0_addr] : 8'bx;	// src/main/scala/chext/amba/axi4/full/components/IdParallelize.scala:123:25
  assign R1_data = R1_en ? Memory[R1_addr] : 8'bx;	// src/main/scala/chext/amba/axi4/full/components/IdParallelize.scala:123:25
  assign R2_data = R2_en ? Memory[R2_addr] : 8'bx;	// src/main/scala/chext/amba/axi4/full/components/IdParallelize.scala:123:25
endmodule

// VCS coverage exclude_file
module read_bufferValid_256x1(	// src/main/scala/chext/amba/axi4/full/components/IdParallelize.scala:125:26
  input  [7:0] R0_addr,
  input        R0_en,
               R0_clk,
  output       R0_data,
  ...
  reg Memory[0:255];	// src/main/scala/chext/amba/axi4/full/components/IdParallelize.scala:125:26
    ...
    initial begin	// src/main/scala/chext/amba/axi4/full/components/IdParallelize.scala:125:26
      ...
      `ifdef RANDOMIZE_MEM_INIT	// src/main/scala/chext/amba/axi4/full/components/IdParallelize.scala:125:26
        for (logic [8:0] i = 9'h0; i < 9'h100; i += 9'h1) begin
          ...
          Memory[i[7:0]] = _RANDOM_MEM[0];	// src/main/scala/chext/amba/axi4/full/components/IdParallelize.scala:125:26
...
module IdParallelize(	// src/main/scala/chext/amba/axi4/full/components/IdParallelize.scala:107:7
  ...
  wire [7:0]  _read_xIndexFill_ext_R0_data;	// src/main/scala/chext/amba/axi4/full/components/IdParallelize.scala:123:25
  wire [7:0]  _read_xIndexFill_ext_R1_data;	// src/main/scala/chext/amba/axi4/full/components/IdParallelize.scala:123:25
  wire [7:0]  _read_xIndexFill_ext_R2_data;	// src/main/scala/chext/amba/axi4/full/components/IdParallelize.scala:123:25
  ...
  reg  [7:0]  read_nextIndexFill;	// src/main/scala/chext/amba/axi4/full/components/IdParallelize.scala:137:32
  reg  [7:0]  read_nextIndexDrain;	// src/main/scala/chext/amba/axi4/full/components/IdParallelize.scala:138:33
  reg  [8:0]  read_bufferAvailable;	// src/main/scala/chext/amba/axi4/full/components/IdParallelize.scala:140:34
  wire [8:0]  _GEN = {1'h0, s_axi_ar_bits_len + 8'h1};	// src/main/scala/chext/amba/axi4/full/components/IdParallelize.scala:107:7, :149:{26,44}, :163:32
  ...
  always @(posedge clock) begin	// <stdin>:603:11
    if (reset) begin	// <stdin>:603:11
      read_nextIdFill <= 7'h0;	// src/main/scala/chext/amba/axi4/full/components/IdParallelize.scala:135:29
      read_nextIndexFill <= 8'h0;	// src/main/scala/chext/amba/axi4/full/components/IdParallelize.scala:137:32
      read_nextIndexDrain <= 8'h0;	// src/main/scala/chext/amba/axi4/full/components/IdParallelize.scala:137:32, :138:33
      read_bufferAvailable <= 9'h100;	// src/main/scala/chext/amba/axi4/full/components/IdParallelize.scala:140:34
    end
      ...
      if (read_m_ar_valid) begin	// src/main/scala/chisel3/util/Decoupled.scala:51:35
        ...
        read_nextIndexFill <= read_nextIndexFill + s_axi_ar_bits_len + 8'h1;	// src/main/scala/chext/amba/axi4/full/components/IdParallelize.scala:137:32, :162:54, :163:32
      ...
      if (_read_T_5)	// src/main/scala/chisel3/util/Decoupled.scala:51:35
        read_nextIndexDrain <= read_nextIndexDrain + 8'h1;	// src/main/scala/chext/amba/axi4/full/components/IdParallelize.scala:138:33, :163:32, :183:40
    end
  ...
  `ifdef ENABLE_INITIAL_REG_	// src/main/scala/chext/amba/axi4/full/components/IdParallelize.scala:107:7
    ...
    initial begin	// src/main/scala/chext/amba/axi4/full/components/IdParallelize.scala:107:7
      ...
      `ifdef RANDOMIZE_REG_INIT	// src/main/scala/chext/amba/axi4/full/components/IdParallelize.scala:107:7
        ...
        read_nextIndexFill = _RANDOM[1'h0][14:7];	// src/main/scala/chext/amba/axi4/full/components/IdParallelize.scala:107:7, :135:29, :137:32
        read_nextIndexDrain = _RANDOM[1'h0][22:15];	// src/main/scala/chext/amba/axi4/full/components/IdParallelize.scala:107:7, :135:29, :138:33
        read_bufferAvailable = _RANDOM[1'h0][31:23];	// src/main/scala/chext/amba/axi4/full/components/IdParallelize.scala:107:7, :135:29, :140:34
        write_nextIdFill = _RANDOM[1'h1][6:0];	// src/main/scala/chext/amba/axi4/full/components/IdParallelize.scala:107:7, :217:25
        write_nextIdDrain = _RANDOM[1'h1][12:7];	// src/main/scala/chext/amba/axi4/full/components/IdParallelize.scala:107:7, :217:25, :218:26
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  read_xIndexFill_64x8 read_xIndexFill_ext (	// src/main/scala/chext/amba/axi4/full/components/IdParallelize.scala:123:25
    ...
    .W0_en   (m_axi_r_valid),
    .W0_clk  (clock),
    .W0_data (_read_xIndexFill_ext_R2_data + 8'h1),	// src/main/scala/chext/amba/axi4/full/components/IdParallelize.scala:123:25, :163:32, :174:66
  ...
  read_bufferValid_256x1 read_bufferValid_ext (	// src/main/scala/chext/amba/axi4/full/components/IdParallelize.scala:125:26
  ...
  Counter_1 read_xCount (	// src/main/scala/chext/amba/axi4/full/components/IdParallelize.scala:142:24
    .clock    (clock),
    .reset    (reset),
  ...
  Counter_1 write_xCount (	// src/main/scala/chext/amba/axi4/full/components/IdParallelize.scala:220:24
    .clock    (clock),
    .reset    (reset),
...
module IdParallelizeTestTop2_6(	// src/test/scala/chext/amba/axi4/full/components/IdParallelize.tb.scala:112:7
  ...
  output [5:0]  M_AXI_ARID,	// src/test/scala/chext/amba/axi4/full/components/IdParallelize.tb.scala:131:17
  ...
  input  [5:0]  M_AXI_RID,	// src/test/scala/chext/amba/axi4/full/components/IdParallelize.tb.scala:131:17
  ...
  output [5:0]  M_AXI_AWID,	// src/test/scala/chext/amba/axi4/full/components/IdParallelize.tb.scala:131:17
  ...
  input  [5:0]  M_AXI_BID,	// src/test/scala/chext/amba/axi4/full/components/IdParallelize.tb.scala:131:17
