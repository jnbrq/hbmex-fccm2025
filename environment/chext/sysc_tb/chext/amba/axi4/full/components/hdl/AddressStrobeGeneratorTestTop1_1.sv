...
module Queue2_AddrLenSizeBurstBundle(	// src/main/scala/chisel3/util/Decoupled.scala:243:7
  ...
  always @(posedge clock) begin	// <stdin>:35:11
    if (reset) begin	// <stdin>:35:11
...
module AddressGenerator(	// src/main/scala/chext/amba/axi4/full/components/AddressGenerator.scala:50:7
  ...
  always @(posedge clock) begin	// <stdin>:137:11
...
module StrobeGenerator(	// src/main/scala/chext/amba/axi4/full/components/AddressGenerator.scala:135:7
  ...
  input  [31:0] source_bits_addr,	// src/main/scala/chext/amba/axi4/full/components/AddressGenerator.scala:139:18
  input  [2:0]  source_bits_size,	// src/main/scala/chext/amba/axi4/full/components/AddressGenerator.scala:139:18
  input         source_bits_last,	// src/main/scala/chext/amba/axi4/full/components/AddressGenerator.scala:139:18
                sink_ready,	// src/main/scala/chext/amba/axi4/full/components/AddressGenerator.scala:140:16
  output        sink_valid,	// src/main/scala/chext/amba/axi4/full/components/AddressGenerator.scala:140:16
  output [31:0] sink_bits_addr,	// src/main/scala/chext/amba/axi4/full/components/AddressGenerator.scala:140:16
  ...
  output [3:0]  sink_bits_lowerByteIndex,	// src/main/scala/chext/amba/axi4/full/components/AddressGenerator.scala:140:16
                sink_bits_upperByteIndex,	// src/main/scala/chext/amba/axi4/full/components/AddressGenerator.scala:140:16
  output        sink_bits_last	// src/main/scala/chext/amba/axi4/full/components/AddressGenerator.scala:140:16
);
  ...
  assign sink_bits_lowerByteIndex = source_bits_addr[3:0];	// src/main/scala/chext/amba/axi4/full/components/AddressGenerator.scala:135:7, :147:25
  assign sink_bits_upperByteIndex = _upperByteIndex_T_4[3:0];	// src/main/scala/chext/amba/axi4/full/components/AddressGenerator.scala:135:7, :153:67, :161:26
  assign sink_bits_last = source_bits_last;	// src/main/scala/chext/amba/axi4/full/components/AddressGenerator.scala:135:7
endmodule

module AddressStrobeGenerator(	// src/main/scala/chext/amba/axi4/full/components/AddressGenerator.scala:173:7
  input         clock,	// <stdin>:343:11
                reset,	// <stdin>:344:11
  ...
  input  [31:0] source_bits_addr,	// src/main/scala/chext/amba/axi4/full/components/AddressGenerator.scala:180:18
  ...
  output [31:0] sink_bits_addr,	// src/main/scala/chext/amba/axi4/full/components/AddressGenerator.scala:181:16
  ...
  output [3:0]  sink_bits_lowerByteIndex,	// src/main/scala/chext/amba/axi4/full/components/AddressGenerator.scala:181:16
                sink_bits_upperByteIndex,	// src/main/scala/chext/amba/axi4/full/components/AddressGenerator.scala:181:16
  output        sink_bits_last	// src/main/scala/chext/amba/axi4/full/components/AddressGenerator.scala:181:16
);
  ...
  wire [31:0] _addressGenerator_sink_bits_addr;	// src/main/scala/chext/amba/axi4/full/components/AddressGenerator.scala:174:40
  wire [2:0]  _addressGenerator_sink_bits_size;	// src/main/scala/chext/amba/axi4/full/components/AddressGenerator.scala:174:40
  wire        _addressGenerator_sink_bits_last;	// src/main/scala/chext/amba/axi4/full/components/AddressGenerator.scala:174:40
  ...
  StrobeGenerator strobeGenerator (	// src/main/scala/chext/amba/axi4/full/components/AddressGenerator.scala:175:39
    ...
    .source_bits_last         (_addressGenerator_sink_bits_last),	// src/main/scala/chext/amba/axi4/full/components/AddressGenerator.scala:174:40
...
module AddressStrobeGeneratorTestTop1_1(	// src/test/scala/chext/amba/axi4/full/components/AddressStrobeGenerator.tb.scala:7:7
  input         clock,	// <stdin>:370:11
                reset,	// <stdin>:371:11
  ...
  output [15:0] sink_bits_strb,	// src/main/scala/chext/TestBench.scala:13:13
  output [3:0]  sink_bits_lowerByteIndex,	// src/main/scala/chext/TestBench.scala:13:13
                sink_bits_upperByteIndex,	// src/main/scala/chext/TestBench.scala:13:13
  output        sink_bits_last	// src/main/scala/chext/TestBench.scala:13:13
);

  AddressStrobeGenerator dut (	// src/test/scala/chext/amba/axi4/full/components/AddressStrobeGenerator.tb.scala:14:27
    .clock                    (clock),
    .reset                    (reset),
    .source_ready             (source_ready),
    .source_valid             (source_valid),
