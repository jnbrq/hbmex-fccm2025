namespace eval ::optrace {
  variable script "/janberq/repos/jnbrq/hbmex/fpga/vivado/alveo_u55c/SpmvExp2/SpmvExp2.runs/impl_1/bd_top_wrapper.tcl"
...
OPTRACE "set parameters" START { }
  set_property webtalk.parent_dir /janberq/repos/jnbrq/hbmex/fpga/vivado/alveo_u55c/SpmvExp2/SpmvExp2.cache/wt [current_project]
  set_property parent.project_path /janberq/repos/jnbrq/hbmex/fpga/vivado/alveo_u55c/SpmvExp2/SpmvExp2.xpr [current_project]
  set_property ip_output_repo /janberq/repos/jnbrq/hbmex/fpga/vivado/alveo_u55c/SpmvExp2/SpmvExp2.cache/ip [current_project]
  set_property ip_cache_permissions {read write} [current_project]
  set_property XPM_LIBRARIES {XPM_CDC XPM_FIFO XPM_MEMORY} [current_project]
OPTRACE "set parameters" END { }
OPTRACE "add files" START { }
  add_files -quiet /janberq/repos/jnbrq/hbmex/fpga/vivado/alveo_u55c/SpmvExp2/SpmvExp2.runs/synth_1/bd_top_wrapper.dcp
  set_msg_config -source 4 -id {BD 41-1661} -limit 0
  set_param project.isImplRun true
  add_files /janberq/repos/jnbrq/hbmex/fpga/vivado/alveo_u55c/SpmvExp2/SpmvExp2.srcs/sources_1/bd/bd_top/bd_top.bd
  set_param project.isImplRun false
OPTRACE "read constraints: implementation" START { }
  read_xdc /janberq/repos/jnbrq/hbmex/fpga/vivado/alveo_u55c/SpmvExp2/SpmvExp2.srcs/constrs_1/alveo_u55c.xdc
