...
##							
##################################################################################################################################################################
# We comment out the followings for compatibility with the block design.
...
# generated using the provided Python script
set_property PACKAGE_PIN BC1 [ get_ports {pci_exp_rxn[15]} ]
set_property PACKAGE_PIN BB3 [ get_ports {pci_exp_rxn[14]} ]
set_property PACKAGE_PIN BA1 [ get_ports {pci_exp_rxn[13]} ]
set_property PACKAGE_PIN BA5 [ get_ports {pci_exp_rxn[12]} ]
set_property PACKAGE_PIN BC2 [ get_ports {pci_exp_rxp[15]} ]
set_property PACKAGE_PIN BB4 [ get_ports {pci_exp_rxp[14]} ]
set_property PACKAGE_PIN BA2 [ get_ports {pci_exp_rxp[13]} ]
set_property PACKAGE_PIN BA6 [ get_ports {pci_exp_rxp[12]} ]
set_property PACKAGE_PIN BC6 [ get_ports {pci_exp_txn[15]} ]
set_property PACKAGE_PIN BC10 [ get_ports {pci_exp_txn[14]} ]
set_property PACKAGE_PIN BB8 [ get_ports {pci_exp_txn[13]} ]
set_property PACKAGE_PIN BA10 [ get_ports {pci_exp_txn[12]} ]
set_property PACKAGE_PIN BC7 [ get_ports {pci_exp_txp[15]} ]
set_property PACKAGE_PIN BC11 [ get_ports {pci_exp_txp[14]} ]
set_property PACKAGE_PIN BB9 [ get_ports {pci_exp_txp[13]} ]
set_property PACKAGE_PIN BA11 [ get_ports {pci_exp_txp[12]} ]
set_property PACKAGE_PIN AY3 [ get_ports {pci_exp_rxn[11]} ]
set_property PACKAGE_PIN AW1 [ get_ports {pci_exp_rxn[10]} ]
set_property PACKAGE_PIN AW5 [ get_ports {pci_exp_rxn[9]} ]
set_property PACKAGE_PIN AV3 [ get_ports {pci_exp_rxn[8]} ]
set_property PACKAGE_PIN AY4 [ get_ports {pci_exp_rxp[11]} ]
set_property PACKAGE_PIN AW2 [ get_ports {pci_exp_rxp[10]} ]
set_property PACKAGE_PIN AW6 [ get_ports {pci_exp_rxp[9]} ]
set_property PACKAGE_PIN AV4 [ get_ports {pci_exp_rxp[8]} ]
set_property PACKAGE_PIN AY8 [ get_ports {pci_exp_txn[11]} ]
set_property PACKAGE_PIN AW10 [ get_ports {pci_exp_txn[10]} ]
set_property PACKAGE_PIN AV8 [ get_ports {pci_exp_txn[9]} ]
set_property PACKAGE_PIN AU6 [ get_ports {pci_exp_txn[8]} ]
set_property PACKAGE_PIN AY9 [ get_ports {pci_exp_txp[11]} ]
set_property PACKAGE_PIN AW11 [ get_ports {pci_exp_txp[10]} ]
set_property PACKAGE_PIN AV9 [ get_ports {pci_exp_txp[9]} ]
set_property PACKAGE_PIN AU7 [ get_ports {pci_exp_txp[8]} ]
