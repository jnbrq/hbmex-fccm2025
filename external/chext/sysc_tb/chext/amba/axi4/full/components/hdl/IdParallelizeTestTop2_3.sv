...
// VCS coverage exclude_file
module mem_256x67(	// src/main/scala/chext/amba/axi4/full/components/IdParallelize.scala:95:18
  input  [7:0]  R0_addr,
  input         R0_en,
                R0_clk,
  output [66:0] R0_data,
  ...
  reg [66:0] Memory[0:255];	// src/main/scala/chext/amba/axi4/full/components/IdParallelize.scala:95:18
    ...
    initial begin	// src/main/scala/chext/amba/axi4/full/components/IdParallelize.scala:95:18
      ...
      `ifdef RANDOMIZE_MEM_INIT	// src/main/scala/chext/amba/axi4/full/components/IdParallelize.scala:95:18
        for (logic [8:0] i = 9'h0; i < 9'h100; i += 9'h1) begin
          ...
          Memory[i[7:0]] = _RANDOM_MEM[66:0];	// src/main/scala/chext/amba/axi4/full/components/IdParallelize.scala:95:18
        end	// src/main/scala/chext/amba/axi4/full/components/IdParallelize.scala:95:18
      `endif // RANDOMIZE_MEM_INIT
    end // initial
  `endif // ENABLE_INITIAL_MEM_
...
module SyncWriteElasticReadMemory(	// src/main/scala/chext/amba/axi4/full/components/IdParallelize.scala:41:15
  ...
  mem_256x67 mem_ext (	// src/main/scala/chext/amba/axi4/full/components/IdParallelize.scala:95:18
...
// VCS coverage exclude_file
module mem_64x34(	// src/main/scala/chext/amba/axi4/full/components/IdParallelize.scala:95:18
  input  [5:0]  R0_addr,
  input         R0_en,
                R0_clk,
  output [33:0] R0_data,
  ...
  reg [33:0] Memory[0:63];	// src/main/scala/chext/amba/axi4/full/components/IdParallelize.scala:95:18
  always @(posedge W0_clk) begin	// src/main/scala/chext/amba/axi4/full/components/IdParallelize.scala:95:18
    if (W0_en & 1'h1)	// src/main/scala/chext/amba/axi4/full/components/IdParallelize.scala:95:18
      Memory[W0_addr] <= W0_data;	// src/main/scala/chext/amba/axi4/full/components/IdParallelize.scala:95:18
  end // always @(posedge)
    ...
    initial begin	// src/main/scala/chext/amba/axi4/full/components/IdParallelize.scala:95:18
      ...
      `ifdef RANDOMIZE_MEM_INIT	// src/main/scala/chext/amba/axi4/full/components/IdParallelize.scala:95:18
        for (logic [6:0] i = 7'h0; i < 7'h40; i += 7'h1) begin
          ...
          Memory[i[5:0]] = _RANDOM_MEM[33:0];	// src/main/scala/chext/amba/axi4/full/components/IdParallelize.scala:95:18
        end	// src/main/scala/chext/amba/axi4/full/components/IdParallelize.scala:95:18
      `endif // RANDOMIZE_MEM_INIT
    end // initial
  `endif // ENABLE_INITIAL_MEM_
...
module SyncWriteElasticReadMemory_1(	// src/main/scala/chext/amba/axi4/full/components/IdParallelize.scala:41:15
  ...
  mem_64x34 mem_ext (	// src/main/scala/chext/amba/axi4/full/components/IdParallelize.scala:95:18
    .R0_addr (io_rdReq_bits),
    .R0_en   (1'h1),	// src/main/scala/chext/amba/axi4/full/components/IdParallelize.scala:41:15
    .R0_clk  (clock),
    .R0_data (_mem_ext_R0_data),
